...
NotificationLibrary:SendNotification("Warning", "Hello", 10)
...
local Tabs = {
    ...
    stack = Window:AddTab({ Title = "Quest", Icon = "power" }), 
...
function RedeemCode(value)
    ...
    Tabs.Main:AddParagraph({
        Title = "KUNTAI LORD HEHE",
        Content = "KaitunFarm cấp ở sea 1 thôi ko có sea 2 & 3"
    })
    --kaitun khá lỏ
    local saygex = Tabs.Main:AddToggle({
    Title = "Kaitun v1 ",
    Description = "lord vl",
    Default = false })

saygex:OnChanged(function(Value)
    _G.RedeemCode = Value
    _G.AutoFarm = Value
...
spawn(function()
    while wait() do
        ...
        local Toggle = Tabs.Se:AddToggle({
...
local SelectedFastAttackModes = Tabs.Settings:AddDropdown({
	Title = "Select Attack",
...
--Sea event
local seaBee = Tabs.Se:AddToggle({
    Title = "Săn sea",
    Description = "",
    Default = false,
    Callback = function(value)
...
Tabs.Se:AddToggle({
    Title = "Đánh cu cặc",
    Description = "CON CẶC CHX CÓ ĐƯỢC CHƯA NHÓC "
})
