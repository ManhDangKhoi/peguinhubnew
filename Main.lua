...
ImageButton.BackgroundColor3 = Color3.fromRGB(3, 252, 40)
ImageButton.BorderColor3 = Color3.fromRGB(3, 252, 40)
...
-- Thêm phần thay đổi màu RGB liên tục cho UIStroke múp hơn mẹ mày
local colors = {
...
-- link gắn icon vô chứ j cu https://lucide.dev/icons/ 
local Tabs = {
    infor = Window:AddTab({ Title = "Infor", Icon = "bell-ring"}),
    Sh = Window:AddTab({ Title = "Shop Tab", Icon = "box" }),
    Main = Window:AddTab({ Title = "Farming Tab", Icon = "home" }),
    Qs = Window:AddTab({ Title = "Sub Farming", Icon = "baby" }), 
    stack = Window:AddTab({ Title = "Stack Farming", Icon = "power" }), 
    Se = Window:AddTab({ Title = "Sea Event Tab", Icon = "package" }),   
    St = Window:AddTab({ Title = "Status and Server", Icon = "timer" }),    
    Lc = Window:AddTab({ Title = "Travel Tab", Icon = "file" }),   
    spl = Window:AddTab({ Title = "Player Status", Icon = "star" }),   
    RC = Window:AddTab({ Title = "Upgrade Race", Icon = "arrow-up" }),
    raid = Window:AddTab({ Title = "Dungeon Tab", Icon = "radio" }),
    De = Window:AddTab({ Title = "Fruit Tab", Icon = "apple" }),    
...
local Seasec = Tabs.Se:AddToggle({
...
local Baoan = Tabs.infor:AddParagraph({
    Title = "Owner",
    Content = "Blue"
})
...
Tabs.infor:AddButton({
    Title = "Discord",
    Description = "Tham gia discord đi các bạn ây!",
    Callback = function()
        setclipboard("https://discord.gg/FnMRyFaq")
    end
})

local Seasecbus = Tabs.Sea:AddToggle({
    Title = "",
    Description = ""
})